...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      ...
      .then(
        () => {
          setNotification({
            message: "Email sent successfully! will get back to you soon..",
            type: "success",
            visible: true,
          });
          form.current.reset();
  ...
  return (
    <div
      name="contact"
      className="bg-gradient-to-b from-black to-gray-800 w-full h-screen text-white justify-center items-center"
    >
      <div className="flex flex-col h-full justify-center max-w-screen-lg p-4 mx-auto">
        <div className="pb-8 text-center">
          ...
          <p className="md:text-lg pt-4 text-sm">
        ...
        <div className="flex justify-center items-center">
          ...
          >
            ...
            <input
              ...
              className="my-4 p-2 border-2 bg-transparent rounded-md focus:outline-none"
              required
            />
            <textarea
              name="Message"
            ...
            <button
              type="submit"
              className="w-fit px-6 py-3 my-4 flex items-center rounded-md bg-gradient-to-r from-cyan-500 to-cyan-800 hover:border-solid hover:border-cyan-500 hover:bg-none border-2 cursor-pointer text-sm sm:text-lg mx-auto"
            >
              Let's Talk
            </button>
          </form>
        ...
        <div className="flex md:hidden justify-center py-2 space-x-4">
          <a
            href="https://www.linkedin.com/in/daliya-r/"
            target="_blank"
            rel="noreferrer"
          >
            <FaLinkedin
